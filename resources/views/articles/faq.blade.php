    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto blog-content">
                <p class="lead text-black">Vous avez encore un doûte ? Vous trouverez forcement la réponse à votre question !</p>

                <br>
                <p class="text-black"><b>Où installer mon spa-jacuzzi ?</b></p>
                ...
                <br>
                <p class="text-black"><b>Quand est-ce que mon spa-jacuzzi sera prêt ?</b></p>
                ...
                <br>
                <p class="text-black"><b>À quel moment se fait l’installation ?</b></p>
                ...
                <br>
                <p class="text-black"><b>Quelles sont vos mesures face au Covid-19 ?</b></p>
                ...
                <br>
                <p class="text-black"><b>Quelles sont vos conditions de paiement ?</b></p>
                ...
                <br>
                <p class="text-black"><b>Pourquoi Bullao et pas un autre ?</b></p>
                ...
                <br>
                <p class="text-black"><b>Comment faire si je dois annuler ma réservation ?</b></p>
                ...
                <br>
                <p class="text-black"><b>Quelles sont vos conditions de remboursements ??</b></p>
