...
class AdministrateurController extends Controller
{
    ...
    {
        $listeAdmins = User::where('user_rank_id', "=", 1)->get();

        return view('system.parametres.administrateurs.list')->with([
    ...
    {
        return view('system.parametres.administrateurs.edit')->with([
            'action'              =>  url('/system/parametres/administrateurs/new')
        ]);
    }
